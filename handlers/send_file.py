...
async def send_media_and_reply(bot: Client, user_id: int, file_ids: list):
    ...
    for file_id in file_ids:
        ...
        asyncio.create_task(delete_after_delay(sent_message, 1800))  # Schedule deletion of each sent message
    ...
    try:
        ...
        await send_media_and_reply(bot, user_id, file_ids)  # Retry sending all files and the important message if FloodWait occurs
